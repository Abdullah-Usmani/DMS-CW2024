...
public class EnemyPlane extends FighterPlane {
	...
	private static final String IMAGE_NAME = Config.enemy1Image;
	private static final double SCALAR =  Config.enemy1Scalar;
	...
	private static final int HORIZONTAL_VELOCITY = Config.enemy1HorizontalVelocity;
	private static final int INITIAL_HEALTH = Config.enemy1InitialHealth;
	private static final double FIRE_RATE = Config.enemy1FireRate;
