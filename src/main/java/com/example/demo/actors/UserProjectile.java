...
public class UserProjectile extends Projectile {
	...
	private static final String IMAGE_NAME = Config.friendlyGun;
	private static final double SCALAR =  Config.userProjectileScalar;
	...
	private static final int HORIZONTAL_VELOCITY = (int) Config.userProjectileHorizontalVelocity;
	private static final int DAMAGE = Config.userProjectileDamage;
